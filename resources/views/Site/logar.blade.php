...
<head>
    ...
    <title>Login</title>
    <link rel="stylesheet" href="{{ url ('assets/pages/login1/style.css')}}">
    ...
    <div class="container">
        <div class="content first-content">
            <div class="first-column">
                ...
                <p class="description description-primary">Por favor efectue login</p>
            ...
            <div class="second-column">
                ...
                <p class="description description-second">Informações necessárias</p>
                <form class="form">
        ...
        <div class="content second-content">
            ...
            <div class="second-column">
                ...
                <form class="form">
                    ...
                    <a class="password" href="#">Lembrar password?</a>
                    <button class="btn btn-second">Entrar</button>
                </form>
            </div><!-- second column -->
        </div><!-- second-content -->
    </div>
    <script src="{{ url ('assets/pages/login1/app.js')}}"></script>
</body>
</html>